...
// See Telegram API docs: https://core.telegram.org/bots/api#setwebhook
...
// See Telegram API docs: https://core.telegram.org/bots/api#getwebhookinfo
...
// See Telegram API docs: https://core.telegram.org/bots/api#deletewebhook
...
// See Telegram API docs: https://core.telegram.org/bots/api#getme
...
// See Telegram API docs: https://core.telegram.org/bots/api#logout
...
// See Telegram API docs: https://core.telegram.org/bots/api#close
...
// See Telegram API docs: https://core.telegram.org/bots/api#editmessagelivelocation
...
// See Telegram API docs: https://core.telegram.org/bots/api#stopmessagelivelocation
...
// See Telegram API docs: https://core.telegram.org/bots/api#sendchataction
...
// See Telegram API docs: https://core.telegram.org/bots/api#getuserprofilephotos
...
// See Telegram API docs: https://core.telegram.org/bots/api#getfile
...
// See Telegram API docs: https://core.telegram.org/bots/api#banchatmember
...
// See Telegram API docs: https://core.telegram.org/bots/api#unbanchatmember
...
// See Telegram API docs: https://core.telegram.org/bots/api#restrictchatmember
...
// See Telegram API docs: https://core.telegram.org/bots/api#promotechatmember
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchatadministratorcustomtitle
...
// See Telegram API docs: https://core.telegram.org/bots/api#banchatsenderchat
...
// See Telegram API docs: https://core.telegram.org/bots/api#unbanchatsenderchat
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchatpermissions
...
// See Telegram API docs: https://core.telegram.org/bots/api#exportchatinvitelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#createchatinvitelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#editchatinvitelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#createchatsubscriptioninvitelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#editchatsubscriptioninvitelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#revokechatinvitelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#approvechatjoinrequest
...
// See Telegram API docs: https://core.telegram.org/bots/api#declinechatjoinrequest
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchatphoto
...
// See Telegram API docs: https://core.telegram.org/bots/api#deletechatphoto
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchattitle
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchatdescription
...
// See Telegram API docs: https://core.telegram.org/bots/api#pinchatmessage
...
// See Telegram API docs: https://core.telegram.org/bots/api#unpinchatmessage
...
// See Telegram API docs: https://core.telegram.org/bots/api#unpinallchatmessages
...
// See Telegram API docs: https://core.telegram.org/bots/api#leavechat
...
// See Telegram API docs: https://core.telegram.org/bots/api#getchat
...
// See Telegram API docs: https://core.telegram.org/bots/api#getchatadministrators
...
// See Telegram API docs: https://core.telegram.org/bots/api#getchatmembercount
...
// See Telegram API docs: https://core.telegram.org/bots/api#getchatmember
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchatstickerset
...
// See Telegram API docs: https://core.telegram.org/bots/api#getforumtopiciconstickers
...
// See Telegram API docs: https://core.telegram.org/bots/api#createforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#editforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#closeforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#reopenforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#deleteforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#editgeneralforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#closegeneralforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#reopengeneralforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#hidegeneralforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#unhidegeneralforumtopic
...
// See Telegram API docs: https://core.telegram.org/bots/api#unpinallgeneralforumtopicmessages
...
// See Telegram API docs: https://core.telegram.org/bots/api#unpinallforumtopicmessages
...
// See Telegram API docs: https://core.telegram.org/bots/api#deletechatstickerset
...
// See Telegram API docs: https://core.telegram.org/bots/api#answercallbackquery
...
// See Telegram API docs: https://core.telegram.org/bots/api#setmycommands
...
// See Telegram API docs: https://core.telegram.org/bots/api#deletemycommands
...
// See Telegram API docs: https://core.telegram.org/bots/api#getmycommands
...
// See Telegram API docs: https://core.telegram.org/bots/api#setmyname
...
// See Telegram API docs: https://core.telegram.org/bots/api#getmyname
...
// See Telegram API docs: https://core.telegram.org/bots/api#setmydescription
...
// See Telegram API docs: https://core.telegram.org/bots/api#getmydescription
...
// See Telegram API docs: https://core.telegram.org/bots/api#setmyshortdescription
...
// See Telegram API docs: https://core.telegram.org/bots/api#getmyshortdescription
...
// See Telegram API docs: https://core.telegram.org/bots/api#setchatmenubutton
...
// See Telegram API docs: https://core.telegram.org/bots/api#getchatmenubutton
...
// See Telegram API docs: https://core.telegram.org/bots/api#setmydefaultadministratorrights
...
// See Telegram API docs: https://core.telegram.org/bots/api#getmydefaultadministratorrights
...
// See Telegram API docs: https://core.telegram.org/bots/api#editmessagecaption
...
// See Telegram API docs: https://core.telegram.org/bots/api#editmessagemedia
...
// See Telegram API docs: https://core.telegram.org/bots/api#editmessagereplymarkup
...
// See Telegram API docs: https://core.telegram.org/bots/api#stoppoll
...
// See Telegram API docs: https://core.telegram.org/bots/api#getstickerset
...
// See Telegram API docs: https://core.telegram.org/bots/api#getcustomemojistickers
...
// See Telegram API docs: https://core.telegram.org/bots/api#uploadstickerfile
...
// See Telegram API docs: https://core.telegram.org/bots/api#createnewstickerset
...
// See Telegram API docs: https://core.telegram.org/bots/api#addstickertoset
...
// See Telegram API docs: https://core.telegram.org/bots/api#setstickerpositioninset
...
// See Telegram API docs: https://core.telegram.org/bots/api#deletestickerfromset
...
// See Telegram API docs: https://core.telegram.org/bots/api#replacestickerinset
...
// See Telegram API docs: https://core.telegram.org/bots/api#setstickeremojilist
...
// See Telegram API docs: https://core.telegram.org/bots/api#setstickerkeywords
...
// See Telegram API docs: https://core.telegram.org/bots/api#setstickermaskposition
...
// See Telegram API docs: https://core.telegram.org/bots/api#setstickersetthumbnail
...
// See Telegram API docs: https://core.telegram.org/bots/api#setcustomemojistickersetthumbnail
...
// See Telegram API docs: https://core.telegram.org/bots/api#deletestickerset
...
// See Telegram API docs: https://core.telegram.org/bots/api#answerwebappquery
...
// See Telegram API docs: https://core.telegram.org/bots/api#createinvoicelink
...
// See Telegram API docs: https://core.telegram.org/bots/api#answershippingquery
...
// See Telegram API docs: https://core.telegram.org/bots/api#answerprecheckoutquery
...
// See Telegram API docs: https://core.telegram.org/bots/api#getmystarbalance
...
// See Telegram API docs: https://core.telegram.org/bots/api#getstartransactions
...
// See Telegram API docs: https://core.telegram.org/bots/api#refundstarpayment
...
// See Telegram API docs: https://core.telegram.org/bots/api#setpassportdataerrors
...
// See Telegram API docs: https://core.telegram.org/bots/api#setgamescore
...
// See Telegram API docs: https://core.telegram.org/bots/api#getgamehighscores
...
// See Telegram API docs: https://core.telegram.org/bots/api#getavailablegifts
